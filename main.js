var newGame = function(){
	...
	else if (gameState = "southGate") {
		console.log("Here she is, the best hippie gathering on the planet.");
		console.log("We've got crunchies, ravers, anarchists, stoners, vegans, hyper-vegans.");
		console.log("Anyone and everyone comes out for Phish.");
		console.log("Welp, let's find some tickets");
		prompt destination = ("Where do you want to look for a ticket?");
